  ...
  return (
      <div>
        ...
        <video autoPlay loop muted playsInline style={{
          ...
          Your browser does not support the video tag. Please try again in a different browser.
        </video>
        <form onSubmit={onSubmitHandler} className={styles.login_box}>
          ...
          <p>아직 계정이 없으신가요? <span>지금 가입하세요!</span></p>
          <p><span>계정이름을 잊으셨나요?</span></p>
          <p><span>비밀번호를 잊으셨나요?</span></p>
          <p><span>회원가입후 자동 내전 팀짜기 서비스를 이용할 수 있습니다.</span></p>
        </form>
